#!/usr/bin/env python3
"""Validate and resolve Ergouzi image model media inputs."""
...
MODEL_MEDIA_FIELDS = {
    ...
    "ergouzi/e-image-try-on": {
        "person_image": MediaField(IMAGE_TYPES),
        "garment_images": MediaField(IMAGE_TYPES, multiple=True),
        "reference_pose": MediaField(IMAGE_TYPES),
    },
